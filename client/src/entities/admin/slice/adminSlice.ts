    ...
    builder
      ...
      .addCase(updateNewsThunk.fulfilled, (state, action) => {
        state.newsArray = state.newsArray.map((news) =>
          news.id === action.payload.data.id ? action.payload.data : news
        );
        state.loading = false;
        state.error = null;
      })
      .addCase(updateNewsThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при обновлении новости";
        state.loading = false;
      })
      ...
      .addCase(deleteNewsThunk.fulfilled, (state, action) => {
        state.newsArray = state.newsArray.filter(
          (news) => Number(news.id) !== Number(action.payload.data.id)
        );
        state.loading = false;
        state.error = null;
      })
      ...
      .addCase(getProductByIdThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при получении продукта";
        state.loading = false;
      })
      ...
      .addCase(updateProductThunk.fulfilled, (state, action) => {
        state.productArray = state.productArray.map((product) =>
      ...
      .addCase(deleteProductThunk.fulfilled, (state, action) => {
        state.productArray = state.productArray.filter(
          (product) => Number(product.id) !== Number(action.payload.data.id)
        );
        state.loading = false;
        state.error = null;
      })
      ...
      .addCase(getAllAdminVacanciesThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при получении вакансий";
        state.loading = false;
      })
      ...
      .addCase(getVacancyByIdThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при получении вакансии";
        state.loading = false;
      })
      ...
      .addCase(updateVacancyThunk.fulfilled, (state, action) => {
        state.vacancyArray = state.vacancyArray.map((vacancy) =>
          vacancy.id === action.payload.data.id ? action.payload.data : vacancy
        );
        state.loading = false;
        state.error = null;
      })
      .addCase(updateVacancyThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при обновлении вакансии";
        state.loading = false;
      })
      ...
      .addCase(deleteVacancyThunk.fulfilled, (state, action) => {
        state.vacancyArray = state.vacancyArray.filter(
          (vacancy) => Number(vacancy.id) !== Number(action.payload.data.id)
        );
        state.loading = false;
        state.error = null;
      })
      ...
      .addCase(updateMainContactThunk.rejected, (state, action) => {
        state.error =
          action.payload?.message || "Ошибка при обновлении вакансий";
        state.loading = false;
      });
  },
});
